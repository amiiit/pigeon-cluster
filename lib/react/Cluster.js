...
var cloneElement = _infact.React.cloneElement;
...
function Cluster(props) {
    ...
    return _infact.React.createElement('div', { className: props.className || '',
        style: { position: 'absolute', height: mapState.height, width: mapState.width } }, displayElements);
}