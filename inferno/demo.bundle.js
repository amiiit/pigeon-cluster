...
/***/ function(module, exports, __webpack_require__) {
	...
	var _coords = __webpack_require__(29);
	...
	var Demo = function (_Component) {
	    ...
	    _createClass(Demo, [{
	        ...
	        value: function render() {
	            ...
	            }, [createVNode(2, 'button', null, 'Add points', {
	                'onClick': this.addPoints
	            }), createVNode(2, 'button', null, 'Remove points', {
	                'onClick': this.removePoints
	            }), createVNode(2, 'span', null, [this.state.displayPoints, ' Points'])]), createVNode(16, _infact3.default, {
	                'center': [50.879, 4.6997],
	                'zoom': 4,
	                'width': 600,
	                'height': 400,
	                children: createVNode(16, _pigeonCluster2.default, {
	                    children: pointsToDisplay.map(function (f) {
	                        return createVNode(16, _infact5.default, {
	                            'anchor': f,
	                            'payload': 1
	                        }, null, null, f.toString());
	                    })
	                })
	            })]);
	        }
